...
type SimpleRestService struct{
	productlineService *ProductlineService
}

func NewSimpleRestService(config []byte, verbose bool) *SimpleRestService{
...
func (simpleRestService *SimpleRestService) Init(config []byte, verbose bool) error {
	if verbose {
...
func (simpleRestService *SimpleRestService) Serve(address string, port int, stopSignal chan bool) {
	...
	simpleRestService.productlineService.AddRouters(router)
